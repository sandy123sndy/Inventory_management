...
<head>
    ...
    <title>This is the customer edit profile page</title>
...
<body>
            ...
            <div class="profile">
                <div class="profile-elements">
                    ...
                    <table>
                        ...
                        <tr><td><i class="fa fa-phone-square" aria-hidden="true"></i></td><td><label for="">Phone number: * </label></td><td><input type="number" name="phnno" id="" required></td></tr>
                    </table>
    ...
    if(request.getParameter("b20")!=null){
    	try{
    		...
    		PreparedStatement pst=con.prepareStatement("update login_table set phone_number='"+phnno+"' where email='"+email+"'");
    		...
    		out.println("<script src='https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.11.4/sweetalert2.all.js'></script>");
     		...
     		out.println("<script>");
     		out.println("$(document).ready(function() {");
     		out.println("swal ('Phone number already in use' , 'Please provide separate phone number' , 'error');");
     		out.println("});");
     		out.println("</script>");
